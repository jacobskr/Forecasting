...
require(plotly)
require(digest)
dta <- read.csv("C:/Users/User/Desktop/Forecasting/Group_Project/US_OIL.csv")
dta2 <- tail(dta, 260)[,2]

#seasons data
seasons <- read.csv("C:/Users/User/Desktop/Forecasting/Group_Project/seasons.csv")
...
oil <- autoplot(ts(dta$barrels, start=1991 +(38/7)/365.25, frequency = 365.25/7),           ylab = "Barrels (Thousands)", main = "U.S. Gasoline Production")
oil <- ggplotly(oil)
